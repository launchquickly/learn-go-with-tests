...
func TestCreateTempFile(t testing.TB, initialData string) (*os.File, func()) {
	t.Helper()
...
func TestGetLeagueFromResponse(t testing.TB, body io.Reader) League {
	t.Helper()
...
func TestNewLeagueRequest() *http.Request {
	req, _ := http.NewRequest(http.MethodGet, "/league", nil)
	return req
}

func TestNewPostWinRequest(name string) *http.Request {
